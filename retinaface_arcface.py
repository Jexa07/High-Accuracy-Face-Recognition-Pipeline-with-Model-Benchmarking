...
while True:
    ...
    # Detect faces using DeepFace's built-in RetinaFace
    face_objs = DeepFace.extract_faces(frame, detector_backend="retinaface", enforce_detection=False)
    ...
    # Display method info
    cv2.putText(frame, "DeepFace RetinaFace + ArcFace", (10, 30),
                cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
